...
from .schemas import CORNER_THRESHOLDS, MlsPrediction
    ...
    with engine.begin() as conn:
        for p in preds:
            conn.execute(sql, {
                ...
                "o15": p.p_over.get(1.5), "o25": p.p_over.get(2.5), "o35": p.p_over.get(3.5),
                "o45": p.p_over.get(4.5), "clh": p.corner_lambda_home, "cla": p.corner_lambda_away,
                "c85": p.p_corners_over.get(8.5), "c95": p.p_corners_over.get(9.5),
                "c105": p.p_corners_over.get(10.5), "c115": p.p_corners_over.get(11.5),
