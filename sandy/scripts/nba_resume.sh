#!/usr/bin/env bash
# Resume NBA bootstrap after the ratings fix (backfill + ratings already done).
set -euo pipefail
...
STEP="calibrate"; echo "[$(date -Iseconds)] calibrate..."; $SANDY nba calibrate 2>&1 | tail -8
...
echo "[$(date -Iseconds)] NBA RESUME COMPLETE"
